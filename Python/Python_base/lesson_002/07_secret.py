...
for i in range(5):
    if i == 0:
        # 4-я буква
        message.append(secret_message[i][3])
    elif i == 1:
        # буквы с 10 по 13, включительно
        message.append(secret_message[i][9:13])
    elif i == 2:
        # буквы с 6 по 15, включительно, через одну
        message.append(secret_message[i][5:15:2])
    elif i == 3:
        # буквы с 8 по 13, включительно, в обратном порядке
        message.append(secret_message[i][12:6:-1])
    elif i == 4:
        # буквы с 17 по 21, включительно, в обратном порядке
        message.append(secret_message[i][20:15:-1])
